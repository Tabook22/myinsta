...
export const translations = {
  en: {
    ...
    noticeTranscriptReady: '🎯 Answering from the saved transcript. Timestamps jump to the video.',
  ...
  ar: {
    ...
    noticeTranscriptReady: '🎯 الإجابة من النص المحفوظ. الطوابع الزمنية تنقلك في الفيديو.',
